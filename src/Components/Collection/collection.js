    ...
    render(){
        ...
        return(
            ...
            <div className="row">
                ...
                <img src={require('../../images/kitchen.webp')} alt="" myvalue="kitchenneeds"/>
                </div>
                ...
                <div className="imgbox">
                <img src={require('../../images/bread.webp')} alt="" myvalue="breadsbakery"/>
                </div>
                <div className="textbox">
                <h5>Breads & Bakery</h5>
                </div>
                ...
                <div className="imgbox">
                <img src={require('../../images/snack.webp')} alt="" myvalue="snacks"/>
                </div>
                <div className="textbox">
                <h5>Snacks</h5>
                </div>
                ...
                <div className="imgbox">
                <img src={require('../../images/beverage.webp')} alt="" myvalue="beverages"/>
                </div>
                <div className="textbox">
                <h5>Beverages</h5>
                </div>
                ...
                <div className="imgbox">
                <img src={require('../../images/personal.webp')} alt="" myvalue="personalcare"/>
                </div>
                <div className="textbox">
                <h5>Personal Care</h5>
                </div>
                ...
                <div className="imgbox">
                <img src={require('../../images/home.webp')} alt="" myvalue="homecare"/>
                </div>
                <div className="textbox">
                <h5>Home Care</h5>
                </div>
                ...
                <div className="imgbox">
                <img src={require('../../images/baby.webp')} alt="" myvalue="babycare"/>
                </div>
                <div className="textbox">
                <h5>Baby Care</h5>
                </div>
                ...
                <div className="imgbox">
                <img src={require('../../images/misc.webp')} alt="" myvalue="miscellaneus"/>
                </div>
                <div className="textbox">
                <h5>Miscellaneus</h5>
                </div>
